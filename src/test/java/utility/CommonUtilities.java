...
public class CommonUtilities 
{
	...
	{
		FileInputStream file = new FileInputStream(System.getProperty("user.dir")+"/resources/propertyFiles/"+propertyFileName);
		prop.load(file);
		
		//wait:explicitwait and implicitWait
	...
	public static void SetAndroidCapabilites()
	{
		...
		cap.setCapability(MobileCapabilityType.AUTOMATION_NAME,AUTOMATION_INSTRUMENTATION);
		//cap.setCapability(MobileCapabilityType.APP, CommonUtils.APPLICATION_NAME);
